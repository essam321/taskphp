...
class Rectangle extends shape
{
    ...
    public function __toString(): string
    {
        return "Recangle[Shape[color={$this->color},filled={$this->filled}],width={$this->width},length={$this->length}]";
    }
}
...
class Square extends Rectangle
{
    ...
    public function __toString(): string
    {
        return "Square[Recangle[Shape[color={$this->color},filled={$this->filled}],width={$this->width},length={$this->length}]]";
    }
}
